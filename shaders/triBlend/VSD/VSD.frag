...
void main() {
	...
	if (targetRGBA.a != 0) 
	{
        vec3 maskedMapPre = BlendSaturation(vec3(targetRGBA.r, targetRGBA.g, targetRGBA.b), vec3(blendRGBA.r,blendRGBA.g, blendRGBA.b));
...
void main() {
	...
	if (textureRGBA_1.a != 0) {
        ...
        if (textureRGBA_2.a != 0) {
            ...
            vec3 maskedMapPre = BlendSaturation(textureRGBA_1.rgb, textureRGBA_2.rgb);
