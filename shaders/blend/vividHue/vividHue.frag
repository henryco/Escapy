...
void main() {
	...
	if (targetRGBA.a != 0) 
	{
		...
		vec3 maskedMapPre = BlendHue(vec3(targetRGBA.r, targetRGBA.g, targetRGBA.b), vec3(blendRGBA.r, blendRGBA.g, blendRGBA.b));
		//vec3 maskedMapPrePre = BlendVividLight(maskedMapPre, blendRGBA);
